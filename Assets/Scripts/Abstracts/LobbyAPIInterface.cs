...
namespace LobbyRelaySample.lobby
{
    ...
    public static class LobbyAPIInterface
    {
        ...
        public static void CreateLobbyAsync(string requesterUASId, string lobbyName, int maxPlayers, bool isPrivate, Dictionary<string, PlayerDataObject> localUserData, Action<Lobby> onComplete)
        {
            ...
            {
                IsPrivate = isPrivate,
                Player = new Unity.Services.Lobbies.Models.Player(id: requesterUASId, data: localUserData)
            };
        ...
        {
            JoinLobbyByCodeOptions joinOptions = new JoinLobbyByCodeOptions { Player = new Unity.Services.Lobbies.Models.Player(id: requesterUASId, data: localUserData) };
        ...
        {
            JoinLobbyByIdOptions joinOptions = new JoinLobbyByIdOptions { Player = new Unity.Services.Lobbies.Models.Player(id: requesterUASId, data: localUserData) };
